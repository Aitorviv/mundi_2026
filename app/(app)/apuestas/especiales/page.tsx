...
export default function ApuestasEspecialesPage() {
  ...
  const totalDone =
    TEAM_CATEGORIES.filter(c => teamBets[c.key]).length +
            ...
            return (
              <div key={cat.key} style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    <span style={{ fontSize: '10px', color: cat.color, background: `${cat.color}20`, border: `0.5px solid ${cat.color}40`, padding: '3px 8px', borderRadius: '20px' }}>
                      {cat.pts} pts
                    </span>
                ...
                />
                {value && (
                  <div style={{ marginTop: '6px', fontSize: '11px', color: cat.color }}>
                    Tu apuesta: {value}
                  </div>
                )}
              </div>
