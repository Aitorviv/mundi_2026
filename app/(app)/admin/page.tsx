...
export default function AdminResultadosPage() {
  ...
  async function assignTeam(matchId: number, side: 'home' | 'away', teamId: number) {
    ...
    setMatches(prev => prev.map(m => {
      ...
      return side === 'home' ? { ...m, home_team_id: teamId, home_team: team } : { ...m, away_team_id: teamId, away_team: team }
    }))
  }
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '24px', flexWrap: 'wrap', gap: '12px' }}>
        <div>
          ...
          <p style={{ fontSize: '12px', color: 'rgba(255,255,255,0.3)' }}>
            Guarda el resultado y luego recalcula los puntos
          </p>
        </div>
        <button
          ...
          style={{
            ...
            padding: '10px 18px', color: '#05080F',
            fontSize: '12px', fontWeight: 600,
            letterSpacing: '0.5px', cursor: calculating ? 'wait' : 'pointer',
            flexShrink: 0,
          }}
        >
        ...
        <div style={{ flex: 1, textAlign: 'right' }}>
          {match.home_team ? (
            ...
            <button onClick={() => { setShowHomeSelector(!showHomeSelector); setSearch('') }} style={{
              ...
              border: '0.5px solid rgba(200,16,46,0.3)', borderRadius: '6px',
        ...
        <div style={{ marginTop: '12px', background: 'rgba(0,0,0,0.3)', borderRadius: '8px', padding: '10px' }}>
          <input
            ...
            style={{
              ...
              borderRadius: '6px', padding: '7px 10px', color: '#ffffff', fontSize: '12px', outline: 'none',
